...
- Markdown：[站内页面](report-step1-model-selection.md)（源文件：`week1/第一版/docs/模型选型报告.md`）
...
- Markdown：[站内页面](report-step1-sft-risk.md)（源文件：`week1/第一版/docs/SFT训练与风险控制.md`）
...
- Markdown：[站内页面](report-step1-csds-stats.md)（源文件：`week1/第一版/stats/outputs/report.md`）
...
- Markdown：[站内页面](report-step1-postal-filter.md)（源文件：`week1/第一版/filter/outputs/report.md`）
...
- Markdown：[站内页面](report-step1-classification-cases.md)（源文件：`week1/第二版/01_分类效果评估与边界case分析/outputs/report.md`）
...
- Markdown：[站内页面](report-step1-cluster-labels.md)（源文件：`week1/第二版/04_可视化聚类与标签优化/outputs/report.md`）
...
- Markdown：[站内页面](report-step2-training-samples.md)（源文件：`week1-module-Web-Crawler/report/training_samples_report.md`）
...
- Markdown：[站内页面](report-step2-llm-system-design.md)（源文件：`week1-module-Web-Crawler/report/llm_system_design_report.md`）
...
- Markdown：[站内页面](report-step3-qwen25-full.md)（源文件：`week3/reports/qwen2.5_mlx_sft_full_experiment_report.md`）
...
- Markdown：[站内页面](report-step3-qwen25-3b-rank-sweep.md)（源文件：`week3/reports/qwen2.5-3b_rank_sweep_report.md`）
